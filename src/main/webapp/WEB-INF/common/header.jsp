    ...
    <ul>
        ...
        <c:choose>
            <c:when test="${not empty userDTO}">
                <li><a class="headerList" href="${pageContext.request.contextPath}/user/userUpdate?uemail=${userDTO.uemail}">회원정보 수정</a></li>
                <li><a class="headerList" href="${pageContext.request.contextPath}/user/userLogout?uemail=${userDTO.uemail}">로그아웃</a></li>
            </c:when>
            <c:otherwise>

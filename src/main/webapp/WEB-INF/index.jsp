...
<body>
	...
	<div class="carouselContainer">
		<img src="${pageContext.request.contextPath}/image/carouselImg1.png"
			class="carouselImg active" alt="Image 1"> <img
			src="${pageContext.request.contextPath}/image/carouselImg2.png"
			class="carouselImg" alt="Image 2"> <img
			src="${pageContext.request.contextPath}/image/carouselImg3.png"
			class="carouselImg" alt="Image 3">
		...
		<section class="dishSection">
			<div class="dishCategory">
				...
				<div class="categoryAll">
					<a href="/MonoRecipe/dish/dishList?pg=1">모두보기 ></a>
				</div>
			</div>
			<div class="dishGrid">
					...
					<c:forEach var="dishDTO" items="${dishList}">
						<div class="dishItem">
							...
							<div class="dishInfo">
								...
								<div class="scoreDiv">
									평점 :
									<fmt:formatNumber value="${dishDTO.dscore}" type="number"

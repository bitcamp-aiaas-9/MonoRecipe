...
<body>
                ...
                <tbody>
                    <tr>
                        <td colspan="2" class="text-center">
                            <img src="https://kr.object.ncloudstorage.com/monorecipe-9th-bucket/storage/${dishDTO.dimageUUID}" alt="${dishDTO.dimage}" class="food-image img-fluid">
                        </td>
                    </tr>
                    <tr>
    ...
    <fieldset class="d-flex gap-2">
        <input type="radio" name="rating" value="1" id="rate1" class="d-none">
        <label for="rate1" class="star">★</label>
        <input type="radio" name="rating" value="2" id="rate2" class="d-none">
        <label for="rate2" class="star">★</label>
        <input type="radio" name="rating" value="3" id="rate3" class="d-none">
        <label for="rate3" class="star">★</label>
        <input type="radio" name="rating" value="4" id="rate4" class="d-none">
        <label for="rate4" class="star">★</label>
        <input type="radio" name="rating" value="5" id="rate5" class="d-none">
        <label for="rate5" class="star">★</label>
    </fieldset>
</div>
                <div class="input-container d-flex flex-column align-items-center mb-2">
    <textarea id="content" name="content" class="form-control" required placeholder="리뷰 내용을 입력하세요" rows="3"></textarea>
    <button type="submit" id="btn-write" class="btn btn-black mt-2">리뷰 제출</button>
</div>
            </form>
<br><br><br>
    ...
    <td class="text-end" width="650">작성날짜</td>
    <td class="text-end review-button-row"> <!-- 여기에 클래스 추가 -->
